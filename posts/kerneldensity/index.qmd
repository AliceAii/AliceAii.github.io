...
housing <- read.table("/Users/aishuhan/Desktop/LAhousingpricesaug2013.txt", header=TRUE)
...
```{r, message=FALSE, warning=FALSE}
# Want to sample from your KDE? Use rejection sampling!
# (We'll show the full code in Section 7)
```
